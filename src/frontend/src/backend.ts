...
export class Backend implements backendInterface {
    ...
    async calculateProfit(arg0: number, arg1: number, arg2: number): Promise<ProfitCalculation> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateProfit(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async calculateTax(arg0: number, arg1: number): Promise<TaxCalculation> {
        if (this.processError) {
            try {
    ...
    async getCryptoPrices(): Promise<Array<CryptoPrice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCryptoPrices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
